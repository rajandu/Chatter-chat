...
public class SignUpActivity extends AppCompatActivity {
    ...
    private TextInputEditText editTextEmailSignup,editTextPasswordSignup,editTextUserNameSignup,editTextConformPasswordSignup;
    private Button buttonRegister;
    private TextView alreadyAccountSignUp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alreadyAccountSignUp=findViewById(R.id.alredyAccountSignUpView);
        ...
        buttonRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if (!email.equals("") && !password.equals("") && !userName.equals("") && !confirmPassword.equals("")  )
                {
